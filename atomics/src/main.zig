...
// Atomics compile to specific machine code
// that make it impossible for the CPUs to execute something else

// Interesting concept to dig: Atomic ordering / Memory ordering
// CPUs can re-order instructions (imagine jump instructions)

// If there are no restrictions, compiler and CPUs they can re-order atomic operations in any fashion they see fit, to make the code as efficient as possible
